 ...
 * it on `req.bastionUser` — deliberately not `req.user`, which the legacy `@User()`
 * decorator in `client/decorators` already reads. Carries no console permission and
 * no client scope; for the
 * console use `@CurrentAdminUser`.
 */
