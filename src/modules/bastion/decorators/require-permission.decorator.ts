 ...
 *
 * `BastionUserGuard` is fail-closed: a route behind it with no metadata is
 * refused to everyone but SUPER_ADMIN, so a missing decorator shows up as a 403
 * instead of silently opening the endpoint.
 */
